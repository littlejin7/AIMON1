...
const LEVEL_RESULT = {
  beginner:     { label: '비기너',       emoji: '🟣', color: '#7c3aed', msg: '아기 슬라임 에이몬이 기다려요!',       desc: 'Python 기초부터 차근차근 함께해요 😊' },
  intermediate: { label: '인터미디에이트', emoji: '🤖', color: '#06b6d4', msg: '로봇 에이몬이 당신을 알아봤어요!',    desc: 'print()는 알고, 더 깊이 파고들 준비 완료!' },
  advanced:     { label: '어드밴스드',   emoji: '👻', color: '#f59e0b', msg: '파이널 에이몬이 라이벌을 발견했어요!', desc: 'f-string까지 꿰뚫는 당신, 에이몬도 긴장했어요 🔥' },
}
    ...
    >
      ...
      >
        ...
        {step === 4 && levelKey && (() => {
          ...
          return (
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '4rem', marginBottom: '0.75rem', filter: `drop-shadow(0 0 24px ${res.color}99)` }}>
                {res.emoji}
              </div>
              <div style={{

  ...
  localStorage.setItem('equipped_title', t.id)
        ...
        <section className="pf-section">
          ...
          <div className="pf-ring-list">
            {[
              { tier: 'ring-purple',  label: '슬라임',  range: 'Lv.1 ~ 9',   emoji: '🟣', active: lv < 10 },
              { tier: 'ring-cyan',    label: '로봇',    range: 'Lv.10 ~ 19', emoji: '🤖', active: lv >= 10 && lv < 20 },
              { tier: 'ring-emerald', label: '말풍선',  range: 'Lv.20 ~ 29', emoji: '💬', active: lv >= 20 && lv < 30 },
              { tier: 'ring-gold',    label: '파이널',  range: 'Lv.30+',     emoji: '👻', active: lv >= 30 },
            ].map((r) => (
